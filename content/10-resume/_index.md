...
{{% badge info %}}HTML/CSS/SASS{{% /badge %}} 
{{% badge info %}}HTML{{% /badge %}} 
{{% badge info %}}.Net 6{{% /badge %}}
{{% badge info %}}.NET Framework{{% /badge %}} 
{{% badge info %}}Entity Framework{{% /badge %}} 
{{% badge info %}}WCF{{% /badge %}} 
{{% badge info %}}WPF/XAML{{% /badge %}} 
{{% badge info %}}SOAP and REST Web Services{{% /badge %}} 
{{% badge info %}}Microsoft SSRS{{% /badge %}} 
{{% badge info %}}Python{{% /badge %}} 
{{% badge info %}}Powershell{{% /badge %}}
{{% badge info %}}Application Security{{% /badge %}}
{{% badge info %}}OWASP ZAP{{% /badge %}}
{{% badge info %}}Database Administration{{% /badge %}} 
{{% badge info %}}T-SQL{{% /badge %}} 
{{% badge info %}}Visual FoxPro{{% /badge %}} 
{{% badge info %}}PowerBuilder{{% /badge %}}
{{% badge info %}}GitHub{{% /badge %}}
{{% badge info %}}SVN{{% /badge %}}
{{% badge info %}}Atlassian Suite{{% /badge %}}
...
{{% badge secondary %}}Application Configuration{{% /badge %}}
{{% badge secondary %}}Application Administration{{% /badge %}}
{{% badge secondary %}}Citrix{{% /badge %}}
{{% badge secondary %}}Microsoft CRM 4.0{{% /badge %}}
{{% badge secondary %}}Sage Pro ERP{{% /badge %}}
{{% badge secondary %}}Great Plains Accounting (Microsoft Dynamics){{% /badge %}}
{{% badge secondary %}}Reporting Tools{{% /badge %}}
...
- GIAC Cloud Security Automation (GCSA) course completed, _exam scheduled Oct. 2022_
...
- Collaborate with Walmart teams outside the SIRT area to pilot platform security controls, integrate application capabilities, and encourage participation in the centralized Walmart developer experience initiative
- 2022 Walmart “Making a Difference” award winner for work done on new streamlined case management system that is integrated with Lab case management and simplifies the Global Investigations and Legal department workflow
- 2021 InfoSec “Leadership in Mentoring” award winner
...
- Received company-wide recognition as a Genesis award winner (2016), and Spark award winner (2017)
...
#### Alpha Data Systems, _Tallahassee, FL_
 ...
 - Worked as technical project manager leading a team of programmers and managing software design, planning and prioritization
